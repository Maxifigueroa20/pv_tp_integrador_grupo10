                ...
                <div className="mx-auto p-4 bg-white border border-1 border-dark rounded-4 shadow-lg" style={{ maxWidth: "900px" }}>
                    <div className="card flex-md-row border-0 bg-transparent">
                        <div className="d-flex align-items-center justify-content-center bg-secondary-subtle rounded-3" style={{ minWidth: "260px", minHeight: "260px", maxWidth: "320px", maxHeight: "320px" }}>
                            <img src={producto.imagen} className="img-fluid object-fit-contain" style={{ width: "220px", height: "220px", mixBlendMode: "multiply" }} alt={producto.nombre} />
                        </div>
                        <div className="card-body d-flex flex-column justify-content-between py-2 px-md-4">
                            ...
                            <div className="d-flex align-items-center mt-3">
                                ...
                                <div className="ms-auto d-flex gap-2">
                                    <Link to="/">
                                        <button type="button" className="btn btn-primary btn-sm px-2 py-1">Volver</button>
                                    </Link>
                                    <Link to={`/editar/${producto.id}`}>
                                        <button type="button" className="btn btn-primary btn-sm px-2 py-1">Editar</button>
                                    </Link>
                                    <button onClick={handleEliminar} type="button" className="btn btn-danger btn-sm px-2 py-1">Eliminar</button>
                                </div>
                            </div>
                            <div className="mt-3">
